	...
	choices = {
		{
			...
			effects = { Money = -"%price%", Fame = 2, Karma = -1 },
		},
		{
			id = "save_more",
	...
	choices = {
		{
			...
			effects = { Money = -"%price%", Happiness = 8, Fame = 3 },
		},
		{
			id = "invest_racing",
	...
	choices = {
		{
			...
			effects = { Money = -"%price%", Happiness = 10, Fame = 5 },
		},
		{
			id = "invest_wisely",
	...
	choices = {
		{
			...
			effects = { Money = -"%price%", Fame = 4, Happiness = 6 },
		},
		{
			id = "save_money",
	...
	choices = {
		{
			...
			careerReputation = 40,
			promoteCareer = true,
			effects = { Money = "%salary%", Fame = 10, Happiness = 12 },
		},
		{
			id = "negotiate_higher",
			...
			careerXP = 65,
			careerReputation = 45,
			effects = { Money = math.floor("%salary%" * 1.2), Fame = 10, Happiness = 12 },
		},
	},
})
	...
	choices = {
		{
			...
			careerReputation = 60,
			promoteCareer = true,
			effects = { Money = "%salary%", Fame = 20, Happiness = 15 },
		},
		{
			id = "wait_better",
			...
			careerXP = 75,
			careerReputation = 55,
			effects = { Money = math.floor("%salary%" * 1.5), Fame = 18, Happiness = 14 },
		},
	},
})
	...
	choices = {
		{
			...
			careerXP = 70,
			careerReputation = 60,
			effects = { Money = "%salary%", Fame = 12, Happiness = 15 },
		},
		{
			id = "stay_independent",
			text = "Stay independent. Keep your freedom.",
			...
			careerXP = 60,
			effects = { Money = math.floor("%salary%" * 1.3), Happiness = 12 },
		},
	},
})
	...
	choices = {
		{
			...
			effects = { Money = -"%price%", Happiness = 10, Fame = 4 },
		},
		{
			id = "invest_career",
	...
	choices = {
		{
			...
			effects = { Money = -"%price%", Happiness = 15, Fame = 8 },
		},
		{
			id = "invest_wisely",
	...
	choices = {
		{
			...
			careerXP = 50,
			careerReputation = 30,
			effects = { Money = "%salary%", Happiness = 8 },
		},
		{
			id = "negotiate_higher",
			text = "Negotiate for more. Know your worth.",
			...
			careerXP = 55,
			careerReputation = 35,
			effects = { Money = math.floor("%salary%" * 1.3), Happiness = 9 },
		},
	},
})
	...
	choices = {
		{
			...
			effects = { Money = -"%price%", Happiness = 20, Fame = 10 },
		},
		{
			id = "invest_future",
