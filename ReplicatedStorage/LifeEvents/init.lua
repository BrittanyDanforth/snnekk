...
-- Add event modules here as they are created
local EVENT_MODULES = {
	-- Core life events that integrate with all screens
	"general_events",  -- General life events covering all life stages and screens
}
